...
//    "org.webjars.npm" % "redux-thunk" % "2.1.0",
    "org.webjars.npm" % "types__react" % "0.14.51",
//    "org.webjars.npm" % "types__react-addons-test-utils" % "0.14.15",
    "org.webjars.npm" % "types__react-dom" % "0.14.19",
    "org.webjars.npm" % "types__react-redux" % "4.4.34",
...
//    "org.webjars.npm" % "types__redux-form" % "4.0.30",
    "org.webjars.npm" % "types__whatwg-fetch" % "0.0.32", // <-- tm hier gekomen
